...
export const SECTION_TITLES: [string, string][] = [
  ...
  ['/games/albion/market-manager/craft-settings', 'AOMM - Craft Settings'],
  ...
  ['/games/albion/market-manager/item', 'AOMM - Item Detail'],
  ['/games/albion/market-manager/compare', 'AOMM - Compare'],
