...
export const ITEMS: ClammingItemDef[] = [
  ...
  { id: 'shall-shell',       name: 'Shall Shell',               vendorPrice: 307,   defaultAHPrice: 833,   defaultAHStackPrice: 10000,  stackSize: 12 },
  { id: 'titanictus-shell',  name: 'Titanictus Shell',          vendorPrice: 350,   defaultAHPrice: 500,   defaultAHStackPrice: 6000,   stackSize: 12 },
  { id: 'coral-fragment',    name: 'Coral Fragment',            vendorPrice: 1735,  defaultAHPrice: 2400,  defaultAHStackPrice: 32000,  stackSize: 12 },
  { id: 'elm-log',           name: 'Elm Log',                   vendorPrice: 390,   defaultAHPrice: 4000,  defaultAHStackPrice: 55000,  stackSize: 12 },
  { id: 'lacquer-tree-log',  name: 'Lacquer Tree Log',          vendorPrice: 3578,  defaultAHPrice: 6000,  defaultAHStackPrice: 80000,  stackSize: 12 },
  ...
  { id: 'crab-shell',        name: 'Crab Shell',                vendorPrice: 371,   defaultAHPrice: 300,   defaultAHStackPrice: 4000,   stackSize: 12 },
  { id: 'fish-scales',       name: 'Fish Scales',               vendorPrice: 23,    defaultAHPrice: 0,     defaultAHStackPrice: 0,      stackSize: 12 },
  { id: 'hq-crab-shell',     name: 'High-Quality Crab Shell',   vendorPrice: 3312,  defaultAHPrice: 3000,  defaultAHStackPrice: 50000,  stackSize: 12 },
  ...
  { id: 'uragnite-shell',    name: 'Uragnite Shell',            vendorPrice: 1455,  defaultAHPrice: 1300,  defaultAHStackPrice: 17000,  stackSize: 12 },
  { id: 'vongola-clam',      name: 'Vongola Clam',              vendorPrice: 192,   defaultAHPrice: 100,   defaultAHStackPrice: 2000,   stackSize: 12 },
  { id: 'white-sand',        name: 'White Sand',                vendorPrice: 250,   defaultAHPrice: 200,   defaultAHStackPrice: 2000,   stackSize: 12 },
]
