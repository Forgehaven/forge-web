  ...
  return (
    <div className="pb-6 max-w-2xl">
      ...
      <div className="bg-[#1a1d27] border border-[#2a2d3a] rounded-lg p-6 flex flex-col gap-4">
        ...
        <div>
          <label className="block text-xs text-[#6b7280] mb-1">Unix Timestamp â†’ Human Date</label>
        ...
        <div>
          <label className="block text-xs text-[#6b7280] mb-1">Human Date â†’ Unix Timestamp</label>
      ...
      {discordTs !== null && (
        <div className="mt-4 bg-[#1a1d27] border border-[#2a2d3a] rounded-lg p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xs text-[#6b7280]">Â· renders in viewer's local time</span>
          </div>
